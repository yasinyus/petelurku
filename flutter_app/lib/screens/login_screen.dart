    ...
    try {
      ...
      if (mounted) {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (_) => MobileDashboardScreen(user: user)));
      }
    } catch (e) {
      if (mounted) {
          ...
          Container(
              ...
              decoration: const BoxDecoration(
                  gradient: LinearGradient(
                      colors: [Color(0xFF064E3B), Color(0xFF0F9F73)],
                          ...
                          child: Column(children: [
                            Container(
                                ...
                                child: const Icon(Icons.egg_alt_rounded,
                                    size: 38, color: Color(0xFF087F5B))),
                            ...
                            const Text('PetelurKu.com',
                                style: TextStyle(
                                    ...
                                    letterSpacing: -.8)),
                            const Text('Produksi kandang dalam satu genggaman',
                            ...
                            Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      const Text(
                                          'Masuk dengan akun peternakan Anda.',
                                          style: TextStyle(
                                      ...
                                      TextField(
                                          ...
                                          cursorColor: const Color(0xFF087F5B),
                                          keyboardType:
